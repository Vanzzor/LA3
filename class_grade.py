...
once we have three hgihest number in the list, we sum them up and divide by 3
...
sort the list, then splice the lowest number
...
grade=input("Enter the 4rth grade: ")
grades.append(float(grade))
